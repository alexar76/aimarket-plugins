...
LABEL org.opencontainers.image.description="All 17 AIMarket verifiable oracles (35 capability tools) as MCP tools"
...
ENTRYPOINT ["python", "-m", "aimarket_oracle_gateway.stdio_server"]
