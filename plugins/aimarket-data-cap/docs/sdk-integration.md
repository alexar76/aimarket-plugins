# aimarket-data-cap — SDK Integration
...
assert any(p["name"] == "aimarket-data-cap" for p in plugins["plugins"])

# 2. Example call
requests.post(f"{HUB}/ai-market/v2/p/aimarket-data-cap/search", json={
...
import aimarket_data_cap  # adjust to package name
```
