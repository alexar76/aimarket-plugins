...
Archive W3C VC receipt per regulated AI decision

### Consumer app

Show verify.modelmarket.dev link next to every AI answer

### Multi-step pipeline

Chain parent_receipts for auditable DAG of model calls
