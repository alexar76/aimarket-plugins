...
> **Try it:** verify any receipt at **[verify.modelmarket.dev](https://verify.modelmarket.dev)** — paste a receipt JSON or open its `verify_url`. Client-side Ed25519 check, no backend.
...
| `AIMARKET_VERIFY_DOMAIN` | `https://verify.modelmarket.dev` | Base URL in `verify_url` links |
