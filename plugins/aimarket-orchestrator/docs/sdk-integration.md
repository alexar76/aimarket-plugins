# aimarket-orchestrator — SDK Integration
...
assert any(p["name"] == "aimarket-orchestrator" for p in plugins["plugins"])

# 2. Example call
plan = requests.post(f"{HUB}/ai-market/v2/p/aimarket-orchestrator/orchestrator/plan", json={
...
import aimarket_orchestrator  # adjust to package name
```
