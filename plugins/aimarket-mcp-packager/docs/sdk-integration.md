# aimarket-mcp-packager — SDK Integration
...
assert any(p["name"] == "aimarket-mcp-packager" for p in plugins["plugins"])

# 2. Example call
requests.post(f"{HUB}/ai-market/v2/p/aimarket-mcp-packager/package", json={
...
import aimarket_mcp_packager  # adjust to package name
```
