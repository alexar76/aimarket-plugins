...
**PyPI (top-5):** [`docs/install.md`](plugins/docs/install.md) — `pip install aimarket-hub` then individual plugins, or `pip install "aimarket-hub[plugins]"`.
...
| **Deep dive** | [docs/killer-feature-tee-escrow.md](plugins/docs/killer-feature-tee-escrow.md) · [Ecosystem killer features](https://github.com/alexar76/aicom/blob/main/docs/killer-features.md) |
...
| [aimarket-provenance](plugins/aimarket-provenance/) | W3C VC invoke receipts |
